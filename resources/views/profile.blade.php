                            ...
                            <tbody>
                                @foreach($vcards as $vcard)
                                    <tr class="search">
                                        ...
                                        <td><a href="/vcard/{{$vcard->id}}" class="btn py-1" style="background-color: #000080; color: white;"><i class="bi bi-eye fs-3"></i></a></td>
                                        <td><a href="/vcard/{{$vcard->id}}/edit" class="btn btn-success py-1"><i class="bi bi-arrow-clockwise fs-3"></i></a></td>
                                        <td><a href="{{ asset('/qrcode/'.$vcard->qr_name) }}" download class="btn btn-dark py-1"><i class="bi bi-qr-code fs-3"></i></a></td>
                                        <td style=" vertical-align: middle ;"><span class="badge rounded-pill bg-dark fs-4">{{$vcard->download_counter}}</span></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
